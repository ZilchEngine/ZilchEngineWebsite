Inheritance allows a *child// [class](https://github.com/ZilchEngine/ZilchDocs/blob/master/zilch_editor_documentation/zilchmanual/nada_in_zero/classes.md) to automatically receive all of the data and functionality defined within the //base* class.
