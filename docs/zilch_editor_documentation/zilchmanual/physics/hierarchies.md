[ Hierarchies](https://github.com/ZilchEngine/ZilchDocs/blob/master/code_reference/class_reference/hierarchy.md) allows physics to building complicated objects from simpler pieces
