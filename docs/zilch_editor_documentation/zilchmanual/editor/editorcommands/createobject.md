Creating an object is a common action within Zilch Engine, in this page we outline all the ways to create one (using Sprite as an example).
 ...
 # Open the [Search Window](commands.md) and type `CreateSprite`
...
- [CreateDirectionalLightShadows](../../../../code_reference/command_reference.md#createdirectionallightsh)
- [CreateGrid](../../../../code_reference/command_reference.md#creategrid)
- [CreatePointLight](../../../../code_reference/command_reference.md#createpointlight)
...
- [CreateWall](../../../../code_reference/command_reference.md#createwall)
- [CreateWedge](../../../../code_reference/command_reference.md#createwedge) 
