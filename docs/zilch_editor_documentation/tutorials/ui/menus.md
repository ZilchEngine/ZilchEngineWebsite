...
(NOTE) **What's a Widget?** In this tutorial, you'll encounter the word **widget**. In short, a widget object is a UI element. Zilch widgets object include //points of interaction//, like buttons and sliders, as well as static elements, like text labels and layouts containing other widgets object. What all widgets object have in common is the [UiWidget](../../../code_reference/class_reference/uiwidget.md) component, which each one has. All graphical user interfaces (or **GUIs**) created with Zilch's UI system, whether they're title screens, main menus, or anything else, are composed of widgets object.
...
The UI level template includes a RootWidget object object, complete with all the special components that make it tick, such as [UiRootWidget](../../../code_reference/class_reference/uirootwidget.md) and `UiRenderer`. It also comes with a few placeholder sprites that we won't be using.
...
- In the `Objects Window`
 - Under RootWidget object
  - [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : the three Sprite object objects
...
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : RootWidget object
- In the `Properties Window`
 - Under [UiRootWidget](../../../code_reference/class_reference/uirootwidget.md)
  - Set LocalColor  to `[R:36, G:36, B:36, A:1.00]`
 - [Remove Component](../../zilchmanual/editor/addremovecomponent.md) : [UiStackLayout](../../../code_reference/class_reference/uistacklayout.md)
 - [Add Component](../../zilchmanual/editor/addremovecomponent.md) : [UiFillLayout](../../../code_reference/class_reference/uifilllayout.md)
...
- In the `Properties Window`
 ...
 - Under [UiWidget](../../../code_reference/class_reference/uiwidget.md)
...
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : Title object
- [Command](../../zilchmanual/editor/editorcommands/commands.md) : [Duplicate](../../../code_reference/command_reference.md#duplicate)
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : the new copy of Title object
- In the `Properties Window`
...
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : Subtitle object
- [Command](../../zilchmanual/editor/editorcommands/commands.md) : [Duplicate](../../../code_reference/command_reference.md#duplicate)
- In the `Properties Window`
...
- In the `Objects Window`
 - Under RootWidget object
  - [Delete](../../../code_reference/command_reference.md#delete) : the three Sprite object objects
 - [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : RootWidget object
- In the `Properties Window`
 - Under [UiRootWidget](../../../code_reference/class_reference/uirootwidget.md)
...
- In the `Properties Window`
 ...
 - Under [UiWidget](../../../code_reference/class_reference/uiwidget.md)
  ...
  - Under the **Layout** group
   ...
   - Set HorizontalAlignment enum to `Center`
 - [Add Component](../../zilchmanual/editor/addremovecomponent.md) : [UiStackLayout](../../../code_reference/class_reference/uistacklayout.md)
 - Under [UiStackLayout](../../../code_reference/class_reference/uistacklayout.md)
...
Zilch's UI system sends the [LeftClick](../../../code_reference/event_reference.md#leftclick) event to every **interactive** widget object (that is, every game object whose [UiWidget](../../../code_reference/class_reference/uiwidget.md) component's `Interactive` property is set to `true`) when it is left-clicked. This component uses that event to load a level of our choice, making it perfect for our menu buttons (and more). But in addition to the functionality offered by this component, we can also add some helpful feedback to the button with a couple more core Nada components: `UiHighlight`, which changes a button's color when it is hovered over or clicked on, and `UiChangeCursor`, which makes a button change the [mouse cursor](../../../code_reference/enum_reference.md#cursor) when it is hovered over.

- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : StartGameButton object
- In the `Properties Window`
 - [Add Component](../../zilchmanual/editor/addremovecomponent.md) : `UiHighlight`
 - [Add Component](../../zilchmanual/editor/addremovecomponent.md) : `UiChangeCursor`
 - [Add Component](../../zilchmanual/editor/addremovecomponent.md) : `LoadLevelOnClick`
 - Under `UiHighlight`
...
- [Duplicate](../../../code_reference/command_reference.md#duplicate) : StartGameButton object three times
...
- Set the Text  properties of the [SpriteText](../../../code_reference/class_reference/spritetext.md) components of the ButtonText object objects to match the following: ![image](https://raw.githubusercontent.com/ZilchEngine/ZilchFiles/master/doc_files/99022.png)
...
When `Escape` is pressed, the [GameRequestQuit](../../../code_reference/event_reference.md#gamerequestquit) event is dispatched to the GameSession object. If this event is not **handled**, the game exits. This component allows us to prevent this.
...
- In the Properties Window
 - [Add Component](../../zilchmanual/editor/addremovecomponent.md) : `QuitHandler`
 - [Add Component](../../zilchmanual/editor/addremovecomponent.md) : `LoadLevelOnKeystroke`
- [Command](../../zilchmanual/editor/editorcommands/commands.md) : [PlayGame](../../../code_reference/command_reference.md#playgame)
...
- [Delete](../../../code_reference/command_reference.md#delete) : CreditsButton object, ReturnToTitleButton object, and QuitGameButton object
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : MenuTitle object
- In the `Properties Window`
 - Under [SpriteText](../../../code_reference/class_reference/spritetext.md)
  - Set Text  to `Credits`
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : StartGameButton object
...
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : ButtonText object
- In the `Properties Window`
 - Under [SpriteText](../../../code_reference/class_reference/spritetext.md)
...
The credits will be displayed between the menu title and the button. We'll place them in a [UiStackLayout](../../../code_reference/class_reference/uistacklayout.md) that we can make by starting with the `UiSprite` archetype. We'll remove its [Sprite](../../../code_reference/class_reference/sprite.md) component, though, so that it's just an invisible layout area. We'll set its SizePolicyY enum to `Auto`, so that it can grow to fit every credit we add.
...
- In the `Properties Window`
 ...
 - [Remove Component](../../zilchmanual/editor/addremovecomponent.md) : [Sprite](../../../code_reference/class_reference/sprite.md)
 - Under [UiWidget](../../../code_reference/class_reference/uiwidget.md)
  - Under the **Layout** group
   - Set SizePolicyX enum to `Flex`
   - Set SizePolicyY enum to `Auto`
...
The credits block should be a vertically stacked list, so we're using a [UiStackLayout](../../../code_reference/class_reference/uistacklayout.md). Each element of the list is a pair of two things: a **role** (to be shown on the left) and the **people** who held that role on your game (to be shown on the right). Thus, each credit is itself a stack layout. (As we'll soon see, the list of people will also be yet another stack layout.)

- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : CreditsBlock object
- [Command](../../zilchmanual/editor/editorcommands/commands.md) : [Duplicate](../../../code_reference/command_reference.md#duplicate)
- In the `Properties Window`
 - Rename the copy of CreditsBlock object to `CreditListing`
- [Attach](../architecture/hierarchies.md) CreditListing object to CreditsBlock object
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : CreditListing object
...
- [Attach](../architecture/hierarchies.md) ListOfPeople object to CreditListing object
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : ListOfPeople object
...
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : Role object
- [Command](../../zilchmanual/editor/editorcommands/commands.md) : [Duplicate](../../../code_reference/command_reference.md#duplicate)
- In the `Properties Window`
 - Rename the copy of Role object to `Person`
- [Attach](../architecture/hierarchies.md) Person object to ListOfPeople object
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : Person object
 - Under [SpriteText](../../../code_reference/class_reference/spritetext.md)
  - Set Text  to `Name`
...
NOTE: Both of the above [Duplicate](../../../code_reference/command_reference.md#duplicate) commands should be executed.
...
- [Duplicate](../../../code_reference/command_reference.md#duplicate) the CreditListing object cogs so that there are enough of them for the credits for your game
- Set the Text  properties of the [SpriteText](../../../code_reference/class_reference/spritetext.md) components of the Role object objects to the names of the roles for your game
- Set the Text  properties of the [SpriteText](../../../code_reference/class_reference/spritetext.md) components of the Person object objects to the names of the people in the corresponding roles

If any of the names of the roles or team members in your credits extend onto multiple lines, just increase the **Y** part of the Size  property of the [UiWidget](../../../code_reference/class_reference/uiwidget.md) component of that name's widget object (say, by doubling it). Alternatively, you could also widen the whole window by increasing the **X** part of the Size  property of the [UiWidget](../../../code_reference/class_reference/uiwidget.md) component of the MenuWindow object object.
...
- In the `Library Window`
 ...
 - Under the Level  tag
  - Open the `MainMenu` Level resource
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : CreditsButton object
- In the `Properties Window`
 - Under `LoadLevelOnClick`
  - Set LevelToLoad enum to `Credits`
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : ReturnToTitleButton object
- In the `Properties Window`
 - Under `LoadLevelOnClick`
...
- [Select](../../zilchmanual/editor/editorcommands/selectobject.md) : QuitGameButton object
- In the `Properties Window`
 - [Remove Component](../../zilchmanual/editor/addremovecomponent.md) : `LoadLevelOnClick`
 - [Add Component](../../zilchmanual/editor/addremovecomponent.md) : `RequestQuitOnClick`
...
- [Command](../../zilchmanual/editor/editorcommands/commands.md) : [StopGame](../../../code_reference/command_reference.md#stopgame)
 ...
 #  Related Materials
 ##  Tutorials
- [hierarchies](../architecture/hierarchies.md)
 ##  Manual
...
- [CreateSprite](../../../code_reference/command_reference.md#createsprite)
 ###  Classes
- [uiwidget](../../../code_reference/class_reference/uiwidget.md)
- [uirootwidget](../../../code_reference/class_reference/uirootwidget.md)
- [uifilllayout](../../../code_reference/class_reference/uifilllayout.md)
- [uistacklayout](../../../code_reference/class_reference/uistacklayout.md)
- [spritetext](../../../code_reference/class_reference/spritetext.md)
- [sprite](../../../code_reference/class_reference/sprite.md)
 ###  Events
- [LeftClick](../../../code_reference/event_reference.md#leftclick)
...
- [KeyDown](../../../code_reference/event_reference.md#keydown)
 ###  Enums
- [Cursor](../../../code_reference/enum_reference.md#cursor)
 ##  Development Task
- T1186
