This lesson covers the basics of Zilch Engine's Tile Editor tool. The [next lesson](tile_editor_ii.md) covers some of its more advanced features.
...
The Tile Editor tool is typically (though not exclusively) used with sprites prepared with the [Sprite Importer](../../zilchmanual/graphics/sprites/spriteimporter.md).
...
Like in the [tutorial on sprite animations](../graphics/sprite_animations.md), we will use the Sprite Importer to take this large tile sheet and extract smaller SpriteSource resource resources from it.
...
- In the `Tools Window`
 - Set ToolType enum to [SelectionTool](../../../code_reference/enum_reference.md#tileeditor2dsubtooltype)
...
- In the `Tools Window`
 - Confirm that the ToolType enum property is set to [SelectionTool](../../../code_reference/enum_reference.md#tileeditor2dsubtooltype)
- In the `Level Window`
...
The test run was a success: the swept character collides with the tiles as expected. In the [next tutorial](tile_editor_ii.md), we'll begin by learning about tile archetypes.
...
- [ImportFrames](../../../code_reference/enum_reference.md#importframes)
- [TileEditor2DSubToolType](../../../code_reference/enum_reference.md#tileeditor2dsubtooltype)
