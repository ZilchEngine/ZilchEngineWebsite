...
5. Specify which Zilch Engine [build version](launcher.md#the-builds-tab) that you want to use to create the project in the **Build** popup menu (build 13480).
...
2. You may choose which installed Zilch Engine [build version](launcher.md#the-builds-tab) you wish to open the project in by selecting the desired build from the **Build** popup menu.
...
2. The `Default Project Location` field defines the default path where new projects will be created.
 - You can use the **Open Path** button next to the field to browse to a desired folder in your operating system's Folder Selection dialog.
 - New projects can still be created elsewhere, by specifying a different path in the [New Project subtab](launcher.md#the-new-project-sub-tab).
